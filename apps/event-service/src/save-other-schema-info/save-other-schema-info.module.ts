...
import { SaveOtherSchemaInfoController } from './save-other-schema-info.controller';
...
@Module({
	...
	controllers: [SaveOtherSchemaInfoController],
	providers: [SaveOtherSchemaInfoService],
})
export class SaveOtherSchemaInfoModule {}
